...
| B4 | `HouseHand_head_mount.stl` + `HouseHand_head_camera.stl` | 1 | filament | Drill to neck r=28 bolt circle |
| B5 | M3 + M4 hardware pack | 1 | 12–18 | Flange 8×M3, rim 6×M3, split 6×M3, splice 8×M3, neck/head 8×M3, pads **8× M4** |
