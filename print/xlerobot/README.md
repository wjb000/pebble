...
| `hardware/HouseHand_neck.stl` | 1 | 82×82×120 | |
| `hardware/HouseHand_head_mount.stl` | 1 | 54×48×39 | Print-origin (was world-frame — fixed) |
| `hardware/HouseHand_head_camera.stl` | 1 | 43×66×36 | |
