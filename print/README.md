...
**Stack:** LeKiwi omni base → **HouseHand torso Ø216** → **shoulder deck** → **2× SO-101** → **neck** → **head + cam**
...
|---|--------|------|----:|-------|
| **1** | Omni base | `print/lekiwi/` | 1 set | plates, 3× `drive_motor_mount_v2`, hubs, battery, Pi case, controller mount |
| **2** | Torso | `print/xlerobot/hardware/HouseHand_torso.stl` | 1 | **Ø216 × 320 mm**, bottom flange → LeKiwi plate |
...
Source: `cad/torso_shell.scad`, `cad/shoulder_deck.scad` (params must stay locked to Ø216 / pads −26±138).
